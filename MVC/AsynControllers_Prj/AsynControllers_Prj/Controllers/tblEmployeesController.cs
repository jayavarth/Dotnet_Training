...
namespace AsynControllers_Prj.Controllers
{
    public class tblEmployeesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "EmpId,EmpName,Gender,Salary,DepartmentId")] tblEmployee tblEmployee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "EmpId,EmpName,Gender,Salary,DepartmentId")] tblEmployee tblEmployee)
        {
            if (ModelState.IsValid)
            {
